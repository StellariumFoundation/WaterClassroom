...
import (
	...
	"github.com/water-classroom/water-classroom-monolith/internal/auth"
	"github.com/water-classroom/water-classroom-monolith/internal/config"
	"github.com/water-classroom/water-classroom-monolith/internal/database"
	"github.com/water-classroom/water-classroom-monolith/internal/middleware"
	"github.com/water-classroom/water-classroom-monolith/internal/router"
	"github.com/water-classroom/water-classroom-monolith/internal/assessment"        // Added
	"github.com/water-classroom/water-classroom-monolith/internal/curriculum"
	"github.com/water-classroom/water-classroom-monolith/internal/notification"     // Added
	"github.com/water-classroom/water-classroom-monolith/internal/payment"
	"github.com/water-classroom/water-classroom-monolith/internal/progress"         // Added
	"github.com/water-classroom/water-classroom-monolith/internal/tutor_orchestrator" // Added
	"github.com/water-classroom/water-classroom-monolith/pkg/logger"
	"go.uber.org/zap"
