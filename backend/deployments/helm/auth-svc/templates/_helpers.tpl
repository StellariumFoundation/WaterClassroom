...
*/}}
{{- define "auth-svc.corsConfig" -}}
{{- if .Values.corsConfig }}
{{- join "," .Values.corsConfig.allowedOrigins }}
{{- end }}
{{- end }}
...
*/}}
{{- define "auth-svc.configMapName" -}}
{{- if .Values.configMap.create }}
{{- default (include "auth-svc.fullname" .) .Values.configMap.name }}
{{- else }}
...
{{- default (include "auth-svc.fullname" .) .Values.secret.name }}
{{- else }}
